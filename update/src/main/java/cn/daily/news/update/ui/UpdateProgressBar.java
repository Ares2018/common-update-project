...
public class UpdateProgressBar extends ProgressBar {
    private static final String TAG = UpdateProgressBar.class.getSimpleName();
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mTextSize = UpdateProgressBar.sp2px(context, 10);
        mTextMargin = UpdateProgressBar.dp2px(context, 4);
        mReachedColor = Color.parseColor("#70A800");
        mReachedHeight = UpdateProgressBar.dp2px(context, 2);
        mUnReachedColor = Color.parseColor("#CCCCCC");
        mUnReachedHeight = UpdateProgressBar.dp2px(context, 1);
        mIsCapRounded = false;
        mIsHiddenText = false;

        mRadius = UpdateProgressBar.dp2px(context, 16);
    }
